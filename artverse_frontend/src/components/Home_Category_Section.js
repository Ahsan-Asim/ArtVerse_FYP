...
function Home_Category_Section() {
  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', padding: '20px' }}>
        <div className="art-card" style={{ width: '30%', margin: '10px' }}>
          ...
          <div className="card-details" style={{ padding: '10px 0' }}>
            <h3 className="art-title" style={{ fontWeight: 'bold' }}>{painting.name}</h3>
            <p>{painting.artist}</p>
            <p>{painting.type}</p>
            <p>{painting.material}</p>
            <p>{painting.dimensions}</p>
            <p style={{ textDecoration: 'line-through', color: '#888' }}>Rs. {painting.oldPrice}</p>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            >
              <img src={ShoppingIcon} alt="Add to Cart" style={{ width: '24px' }} />
            </button>
          </div>
        </div>
        {/* Button to View Cart */}
      ...
      <button className="icon-container" style={{
        ...
        <img src={LikeIcon} alt="Like" style={{ width: '24px', height: '24px' }} />
      </button>
      <button className="icon-container" style={{
        backgroundColor: '#FFFFFF',
        border: '1px solid #000000',
        ...
        <img src={ShoppingIcon} alt="Shopping" style={{ width: '24px', height: '24px' }} />
      </button>
      </div>
